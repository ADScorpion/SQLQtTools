...
from SqlQtTools.qt.core import (QSortFilterProxyModel, Qt, QSize, QMainWindow, QMdiArea, QMessageBox, QDialog, QPushButton, QHBoxLayout, QVBoxLayout, QLineEdit,
...
class SysBaseWidgetView(QWidget):
    ...
    title = "Форма #"
    win_icon = '/icons/bootstrap/rocket-takeoff.ico'
    action = None
    ...
    def init_action(cls, parent=None):
        cls.action = QAction(ResourceManager.get_icon(cls.win_icon), cls.title, parent)
    ...
    def active_triggered(self, parent=None, children=None):
        ...
        subwindow.setWindowIcon(ResourceManager.get_icon(parent.win_icon))
        subwindow.show()
    ...
    def init_view(cls, view, parent, data, field):
        ...
        subwindow.setWindowIcon(ResourceManager.get_icon(_view.win_icon))
        subwindow.show()
