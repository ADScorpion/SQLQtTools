from SqlQtTools.qt.compat import QFile, QIcon, QPixmap
# from SqlQtTools.qt.compat import QSize, QByteArray, Qt, QPainter, QSvgRenderer
import SqlQtTools.qt.resources
